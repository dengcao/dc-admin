        ...
        listen: function (options) {
            $('body').on('click', '[data-bgcolor]', function () {
                ...
                var html = '<div class="layuimini-color">\n' +
                    ...
                    '<a class="more-menu-item" href="https://gitee.com/'+dengcao_sys_gitee+'" target="_blank"><i class="layui-icon layui-icon-read" style="font-size: 19px;"></i> '+dengcao_sys_name+'  '+dengcao_sys_version+'</a>\n' +
                    ...
                    '<a class="more-menu-item" href="http://t.5300.cn/" target="_blank"><i class="layui-icon layui-icon-theme"></i> 工具大全</a>\n' +
                    '</div>' +
                    '</div>';
                layer.open({
                    type: 1,
